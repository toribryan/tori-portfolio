...
const ChartTooltipContent = ({
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "grid min-w-[12rem] items-start gap-1.5 rounded-lg border border-line bg-popover px-3 py-2 text-xs text-popover-foreground shadow-md",
        className
      )}
    >
...
export { Chart, ChartTooltip, ChartTooltipContent, ChartStyle }
