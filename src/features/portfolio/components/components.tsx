 ...
 * then every component as a row into its page.
 */
export async function Components() {
  const featured = COMPONENTS.find((entry) => entry.links.post)
  const post = featured?.links.post
    ? await getTweet(featured.links.post.id).catch((error) => {
