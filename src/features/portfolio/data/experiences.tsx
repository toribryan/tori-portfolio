    ...
    positions: [
      {
        ...
        icon: <CodeIcon />,
        description: `- Independent practice, full time since August 2026: design systems, product design, and the production front end that ships them, mainly through SLV Technologies for their clients.
