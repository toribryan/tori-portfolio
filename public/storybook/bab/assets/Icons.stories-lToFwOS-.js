...
}`,...U.parameters?.docs?.source},description:{story:`Selection changes weight, not the glyph. Every destination steps from the
base stroke to the selected stroke on the same outline, so all of them gain
the same amount. Actions like search never change.`,...U.parameters?.docs?.description}}},W=[`Weight`,`SelectedState`]})))()}G();export{U as SelectedState,H as Weight,W as __namedExportsOrder,V as default};